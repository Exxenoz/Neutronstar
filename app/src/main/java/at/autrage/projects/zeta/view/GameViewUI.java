...
public class GameViewUI {
    /** Reference to the population text view element. */
    public TextView TxtViewPopulation;
    /** Reference to the money text view element. */
    public TextView TxtViewMoney;
    /** Reference to the level text view element. */
    public TextView TxtViewLevel;
    /** Reference to the score text view element. */
    public TextView TxtViewScore;
    /** Reference to the time text view element. */
