...
public class CircleCollider extends Collider {
    ...
    public CircleCollider(GameObject owner, float radius) {
        ...
        if (Pustafin.DebugMode) {
            m_DebugCircle = new Sprite(owner.getGameView(), m_OwnerTransform.getPositionX(), m_OwnerTransform.getPositionY(), AssetManager.getInstance().getAnimationSet(AnimationSets.DebugCircle));
            ...
            m_DebugCircle.getTransform().setParent(m_OwnerTransform);
        }
    }
