...
public class TutorialManager {
    ...
    private TutorialEntry[] m_TutorialEntries = new TutorialEntry[] {
        ...
        /*15*/ new TutorialEntry(1230, 115, RelativeLayout.ALIGN_PARENT_LEFT, RelativeLayout.ALIGN_PARENT_TOP, false, true, R.string.tv_desc_score1, 320, 256, ViewGroup.LayoutParams.WRAP_CONTENT, RelativeLayout.ALIGN_PARENT_RIGHT, RelativeLayout.ALIGN_PARENT_TOP),
