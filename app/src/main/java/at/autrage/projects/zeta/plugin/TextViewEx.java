package at.autrage.projects.zeta.plugin;
...
public class TextViewEx extends TextView {
    ...
    public void setText(String st, boolean wrap) {
        wrapEnabled = wrap;
        if (!wrap) {
            Util.setViewHeight(this, ViewGroup.LayoutParams.WRAP_CONTENT);
        }
        super.setText(st);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        verticalOffset = getPaddingTop() + getTextSize();
        horizontalFontOffset = getLineHeight() - 0.5f; // Temp
        // fix
